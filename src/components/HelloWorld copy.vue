<template>
 <div>
  ...
  <div class="image-item space" @click="showActionSheet()" style="background:red;">
   <div class="image-up">方法showActionSheet() - 38</div>
  </div>
   ...
   <div class="upload_warp_img">
    <div class="upload_warp_img_div" v-for="(item,index) in imgList" :key="index">
     ...
     <div style="width:300px;height:300px">
       <img :src="item.file.src" style="width:100%;height:100%">
     </div>
    </div>
